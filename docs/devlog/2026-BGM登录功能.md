...
![BGM 登录态绑定 UA 修复前后对比](../devlog-assets/bgm-ua-binding-fix.svg)
...
![BgmLoginChip 状态流转](../devlog-assets/bgm-login-chip-states.svg)
...
![BGM 搜索请求结果分类](../devlog-assets/bgm-search-classify.svg)
...
![BGM 两个 cookie 的说明](../devlog-assets/bgm-cookie-flow.svg)
...
![BGM 内嵌登录数据流程](../devlog-assets/bgm-login-flow.svg)
