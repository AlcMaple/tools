...
>
> 配套阶段日志：[docs/ideas/007-自动更新国内加速.md](ideas/007-自动更新国内加速.md)
...
C:\Users\example-user>curl -i -L --max-time 15 "https://ghproxy.net/https://raw.githubusercontent.com/AlcMaple/tools/main/update-manifest.json"
HTTP/1.1 200 OK
Server: nginx
...
status:
body 摘要:
C:\Users\example-user>curl -i -L --max-time 15 "https://ghfast.top/https://raw.githubusercontent.com/AlcMaple/tools/main/update-manifest.json"
HTTP/1.1 200 OK
Server: nginx
...
C:\Users\example-user>curl -i -L --max-time 15 "https://cdn.jsdelivr.net/gh/AlcMaple/tools@main/update-manifest.json"
HTTP/1.1 200 OK
Connection: keep-alive
Content-Length: 161
Access-Control-Allow-Origin: *
...
C:\Users\example-user>curl -i -L --max-time 15 "https://raw.githubusercontent.com/AlcMaple/tools/main/update-manifest.json"
HTTP/1.1 200 OK
Connection: keep-alive
Content-Length: 161
Cache-Control: max-age=300
