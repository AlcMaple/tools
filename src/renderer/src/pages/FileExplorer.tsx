...
const FS: Record<string, FsNode> = {
  ...
  'C:\\Users': { type: 'folder', name: 'Users', mtime: '2026-04-22 11:02',
    children: ['C:\\Users\\example-user', 'C:\\Users\\Public'] },
  'C:\\Users\\Public': { type: 'folder', name: 'Public', mtime: '2026-01-08 10:00', children: [] },
  'C:\\Users\\example-user': { type: 'folder', name: 'Yuming', mtime: '2026-04-25 22:48',
    children: [
      'C:\\Users\\example-user\\Desktop', 'C:\\Users\\example-user\\Documents',
      'C:\\Users\\example-user\\Downloads', 'C:\\Users\\example-user\\Videos',
      'C:\\Users\\example-user\\Pictures', 'C:\\Users\\example-user\\Music',
    ] },
  ...
  'C:\\Users\\example-user\\Desktop': { type: 'folder', name: 'Desktop', mtime: '2026-04-26 19:01',
    children: ['C:\\Users\\example-user\\Desktop\\SoraIndex.lnk', 'C:\\Users\\example-user\\Desktop\\readme.txt'] },
  'C:\\Users\\example-user\\Desktop\\SoraIndex.lnk': { type: 'file', name: 'SoraIndex.lnk', ext: 'lnk', size: 1862, mtime: '2026-04-12 10:22', kind: 'shortcut' },
  'C:\\Users\\example-user\\Desktop\\readme.txt': { type: 'file', name: 'readme.txt', ext: 'txt', size: 412, mtime: '2026-04-26 18:55', kind: 'text' },
  'C:\\Users\\example-user\\Documents': { type: 'folder', name: 'Documents', mtime: '2026-04-22 14:08', children: [] },
  'C:\\Users\\example-user\\Pictures': { type: 'folder', name: 'Pictures', mtime: '2026-03-30 09:00', children: [] },
  'C:\\Users\\example-user\\Music': { type: 'folder', name: 'Music', mtime: '2026-04-18 21:45', children: [] },
  'C:\\Users\\example-user\\Downloads': { type: 'folder', name: 'Downloads', mtime: '2026-04-26 20:31',
    children: [
      'C:\\Users\\example-user\\Downloads\\[SoraIndex] Frieren - 17.mkv',
      'C:\\Users\\example-user\\Downloads\\[SoraIndex] Frieren - 18.mkv',
      'C:\\Users\\example-user\\Downloads\\subtitles.zip',
      'C:\\Users\\example-user\\Downloads\\poster_collection',
    ] },
  'C:\\Users\\example-user\\Downloads\\[SoraIndex] Frieren - 17.mkv': { type: 'file', name: '[SoraIndex] Frieren - 17.mkv', ext: 'mkv', size: 1342177280, mtime: '2026-04-26 20:31', kind: 'video' },
  'C:\\Users\\example-user\\Downloads\\[SoraIndex] Frieren - 18.mkv': { type: 'file', name: '[SoraIndex] Frieren - 18.mkv', ext: 'mkv', size: 1289748480, mtime: '2026-04-26 20:31', kind: 'video' },
  'C:\\Users\\example-user\\Downloads\\subtitles.zip': { type: 'file', name: 'subtitles.zip', ext: 'zip', size: 4823422, mtime: '2026-04-25 14:08', kind: 'archive' },
  'C:\\Users\\example-user\\Downloads\\poster_collection': { type: 'folder', name: 'poster_collection', mtime: '2026-04-20 11:18', children: [] },
  'C:\\Users\\example-user\\Videos': { type: 'folder', name: 'Videos', mtime: '2026-04-25 22:14',
    children: [
      'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners',
      'C:\\Users\\example-user\\Videos\\Cowboy Bebop',
      'C:\\Users\\example-user\\Videos\\Sousou no Frieren',
      'C:\\Users\\example-user\\Videos\\Vinland Saga',
      'C:\\Users\\example-user\\Videos\\screen_capture.mp4',
    ] },
  'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners': { type: 'folder', name: 'Cyberpunk Edgerunners', mtime: '2026-04-22 23:11',
    children: [
      'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\E01.mkv',
      'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\E02.mkv',
      'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\E03.mkv',
      'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\poster.jpg',
    ] },
  'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\E01.mkv': { type: 'file', name: '[SoraIndex] Cyberpunk Edgerunners - 01.mkv', ext: 'mkv', size: 1431655765, mtime: '2026-04-22 22:48', kind: 'video' },
  'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\E02.mkv': { type: 'file', name: '[SoraIndex] Cyberpunk Edgerunners - 02.mkv', ext: 'mkv', size: 1395864371, mtime: '2026-04-22 22:50', kind: 'video' },
  'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\E03.mkv': { type: 'file', name: '[SoraIndex] Cyberpunk Edgerunners - 03.mkv', ext: 'mkv', size: 1502468608, mtime: '2026-04-22 22:54', kind: 'video' },
  'C:\\Users\\example-user\\Videos\\Cyberpunk Edgerunners\\poster.jpg': { type: 'file', name: 'poster.jpg', ext: 'jpg', size: 482718, mtime: '2026-04-21 09:20', kind: 'image' },
  'C:\\Users\\example-user\\Videos\\Cowboy Bebop': { type: 'folder', name: 'Cowboy Bebop', mtime: '2026-04-19 14:00', children: [] },
  'C:\\Users\\example-user\\Videos\\Sousou no Frieren': { type: 'folder', name: 'Sousou no Frieren', mtime: '2026-04-25 19:40', children: [] },
  'C:\\Users\\example-user\\Videos\\Vinland Saga': { type: 'folder', name: 'Vinland Saga', mtime: '2026-04-15 11:22', children: [] },
  'C:\\Users\\example-user\\Videos\\screen_capture.mp4': { type: 'file', name: 'screen_capture.mp4', ext: 'mp4', size: 286331153, mtime: '2026-04-24 16:18', kind: 'video' },
...
function FileExplorer(): JSX.Element {
  const [cwd, setCwd] = useState('C:\\Users\\example-user\\Videos')
  const [history, setHistory] = useState<string[]>(['C:\\Users\\example-user\\Videos'])
  ...
  const [addressInput, setAddressInput] = useState('C:\\Users\\example-user\\Videos')
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <div className="flex-1 flex items-stretch bg-surface-container-lowest rounded-lg border border-white/5 focus-within:border-primary/50 transition-colors overflow-hidden">
            ...
            <input
              ...
              placeholder={'输入绝对路径,例如 C:\\Users\\example-user\\Videos'}
              spellCheck={false}
