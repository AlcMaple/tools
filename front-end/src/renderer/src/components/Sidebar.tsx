  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 bg-[#0e0e0e] flex flex-col py-8 z-50">
      ...
      <div className="px-6 mb-12">
        <h1 className="text-xl font-black text-[#ffb3b8] tracking-tighter">ARCHIVIST</h1>
        <p className="font-label text-[10px] text-[#e2e2e2]/40 tracking-widest mt-1">V2.4.0</p>
      </div>
