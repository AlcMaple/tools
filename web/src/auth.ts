...
let providersCache: { google: boolean; github: boolean; linuxdo: boolean; email: boolean } | null = null
export async function fetchOauthProviders(): Promise<{ google: boolean; github: boolean; linuxdo: boolean; email: boolean }> {
  if (!providersCache) providersCache = await request<{ google: boolean; github: boolean; linuxdo: boolean; email: boolean }>('/oauth/providers')
