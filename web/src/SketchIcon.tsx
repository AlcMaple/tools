...
<symbol id="i-github" viewBox="0 0 24 24"><path fill="currentColor" stroke="none" d="M12 .5a12 12 0 0 0-3.79 23.39c.6.11.82-.26.82-.58v-2.23c-3.34.73-4.04-1.42-4.04-1.42-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.73.08-.73 1.21.08 1.84 1.24 1.84 1.24 1.07 1.83 2.81 1.3 3.49.99.11-.78.42-1.3.76-1.6-2.66-.3-5.47-1.34-5.47-5.93 0-1.31.47-2.38 1.24-3.22-.12-.3-.54-1.52.12-3.18 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 0 1 6 0c2.29-1.55 3.3-1.23 3.3-1.23.66 1.66.24 2.88.12 3.18.77.84 1.24 1.91 1.24 3.22 0 4.6-2.81 5.63-5.49 5.93.43.37.82 1.1.82 2.22v3.29c0 .32.22.7.83.58A12 12 0 0 0 12 .5z"/></symbol>
<symbol id="i-linuxdo" viewBox="0 0 24 24"><circle cx="12" cy="12" r="11" fill="#f0f0f0" stroke="#777" strokeWidth=".5"/><path d="M1.63 8a11 11 0 0 1 20.74 0Z" fill="#222" stroke="none"/><path d="M1.63 16a11 11 0 0 0 20.74 0Z" fill="#ffb003" stroke="none"/></symbol>
...
export type SketchIconName =
  ...
  | 'external' | 'dots' | 'logout' | 'clip' | 'tag' | 'edit' | 'mail' | 'google' | 'github' | 'linuxdo' | 'pause' | 'back' | 'heart'
  | 'ticket' | 'gift'
